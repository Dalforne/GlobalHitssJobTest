...
import com.global.hitss.store.services.ClientService;
...
public class ClientResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody ClientNewDTO objDto){
		...
		URI uri = ServletUriComponentsBuilder.fromCurrentRequest()
				.path("/{id}").buildAndExpand(obj.getIdClient()).toUri();
	...
	public ResponseEntity<Page<ClientDTO>> findPage(
			...
			@RequestParam(value="orderBy", defaultValue="dsClient") String orderBy, 
			@RequestParam(value="derection", defaultValue="ASC") String derection) {
		Page<Client> list  = service.findPage(page, linesPerPager, orderBy, derection);
