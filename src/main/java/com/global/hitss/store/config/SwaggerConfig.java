...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.global.hitss.store.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
		 "Global Hitss Store",
		 "Global Hitss Store JobTest",
		 "Versão 1.0",
		 "http://www.apache.org/licenses/LICENSE-2.0.html",
		 new Contact("Renato Dalforne", "renatodalforne.com.br", "renato.dalforne@gmail.com"),
		 "Permitido uso para avaliação de emprego",
		 "http://www.apache.org/licenses/LICENSE-2.0.html",
